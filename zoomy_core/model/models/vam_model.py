...
# =============================================================================
# VAMModelTagged — REMOVED (same reason as SMEModelTagged; see sme_model.py).
#
# A proper tag-driven VAM must derive scalar tagged equations from the
# symbolic INS chain and ``Expression.project_onto_basis``, not by
# re-reading the hand-coded VAMModel operators.  That pipeline is
# non-trivial and tracked as a follow-up.
# =============================================================================
